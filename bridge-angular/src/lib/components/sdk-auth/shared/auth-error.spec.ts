 ...
 * Runs against the auth-core this workspace installs (published
 * 0.7.0-beta.0), which predates the `ORIGIN_NOT_ALLOWED` code — i.e. the
 * plain-HttpError path older apps hit.
 */
...
// jsdom's location cannot be stubbed; its origin is the page origin here.
...
it('runs with a real page origin', () => {
