 ...
 * auth-core: the published 0.7.0-beta.0 in the peer range predates these
 * exports, and a consumer on it must still build.
 */
...
/** The page's origin, or undefined outside a browser (SSR, tests without a location). */
