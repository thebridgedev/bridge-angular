// Config getter is injected at runtime — avoids circular dep
let _getConfig: (() => { debug?: boolean }) | null = null;

export function setLoggerConfigGetter(fn: () => { debug?: boolean }) {
  _getConfig = fn;
}
