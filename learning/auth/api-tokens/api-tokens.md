...
A drop-in component (`<bridge-api-token-management>`) handles the whole self-service flow — listing, creating, revoking — so you don't have to build a token management screen yourself. See [Tokens](/auth/ui/tokens/) in UI components.
