...
2. Under **Authorised JavaScript origins**, add Bridge's hosted auth domain: `https://auth.thebridge.dev` (or your own custom hosted-auth domain, if you've configured one — see [Configurations](/auth/config/config/)).
